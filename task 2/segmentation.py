...
total_spending = st.number_input("Total Spending(sum of purchases)",min_value = 0 ,max_value =50000 ,value =1000)
...
num_web_visits =st.number_input("Number of web visit per Month",min_value=0,max_value = 50,value=3)
